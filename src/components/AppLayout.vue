<template>
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
    <!-- Header -->
    <header class="bg-blue-500 dark:bg-blue-600 text-white transition-colors duration-200 sticky top-0 z-50 shadow-md">
      <div class="flex items-center justify-between px-4 py-2">
        ...
        <div class="relative user-menu">
          <button
            ...
            class="flex items-center space-x-2 px-3 py-1 hover:bg-blue-600 dark:hover:bg-blue-700 rounded text-sm"
          >
          ...
          <div
            v-if="showUserMenu"
            class="absolute right-0 mt-1 w-48 bg-white dark:bg-gray-800 rounded shadow-lg z-50 border dark:border-gray-700"
          >
            <div class="py-1">
              <div class="px-3 py-2 text-sm text-gray-700 dark:text-gray-300 border-b dark:border-gray-600">
                <div class="font-medium">{{ authStore.currentUser?.name }}</div>
                <div class="text-xs text-gray-500 dark:text-gray-400">{{ authStore.currentUser?.role }}</div>
              </div>
              <button
    ...
    <div class="flex">
      <!-- Sidebar -->
      <aside
        class="bg-white dark:bg-gray-800 shadow-sm transition-all duration-300 ease-in-out overflow-hidden border-r dark:border-gray-700"
      ...
      <!-- Main content -->
      <main class="flex-1 p-6 bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
        <slot />
      </main>
    </div>
  </div>
